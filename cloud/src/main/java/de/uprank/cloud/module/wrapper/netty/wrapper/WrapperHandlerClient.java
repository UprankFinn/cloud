...
import de.uprank.cloud.module.wrapper.netty.player.PlayerHandler;
...
public class WrapperHandlerClient implements Runnable {
    ...
    public WrapperHandlerClient(WrapperModule wrapperModule, String hostName, Integer port) {
            ...
            bootstrap.group(eventLoopGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            channelPipeline.addLast(new WrapperHandler(wrapperModule));
