...
import de.uprank.cloud.module.wrapper.netty.server.ServerHandler;
...
public class ProxyHandlerClient implements Runnable {
    ...
    public ProxyHandlerClient(WrapperModule wrapperModule, String hostName, Integer port) {
            ...
            bootstrap.group(eventLoopGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            channelPipeline.addLast(new ProxyHandler(wrapperModule));
