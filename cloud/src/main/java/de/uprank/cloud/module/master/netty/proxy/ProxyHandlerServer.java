...
import de.uprank.cloud.module.master.netty.player.PlayerHandler;
...
public class ProxyHandlerServer implements Runnable {

    private final MasterModule masterModule;

    private final Integer port;

    public ProxyHandlerServer(MasterModule masterModule, Integer port) {
            ...
            serverBootstrap.group(bossGroup, workerGroup)
                    ...
                    .childHandler(new ChannelInitializer<SocketChannel>() {
                        ...
                        public void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            channelPipeline.addLast(new ProxyHandler(masterModule));
