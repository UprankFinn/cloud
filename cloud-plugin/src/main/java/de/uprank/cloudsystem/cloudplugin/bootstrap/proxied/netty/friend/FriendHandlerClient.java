...
import de.uprank.cloudsystem.cloudplugin.bootstrap.bukkit.netty.wrapper.WrapperHandler;
...
public class FriendHandlerClient implements Runnable {
    ...
    public FriendHandlerClient(CloudProxiedPlugin plugin, String hostName, Integer port) {
        this.plugin = plugin;
            ...
            bootstrap.group(eventLoopGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            channelPipeline.addLast(new FriendHandler(plugin));
