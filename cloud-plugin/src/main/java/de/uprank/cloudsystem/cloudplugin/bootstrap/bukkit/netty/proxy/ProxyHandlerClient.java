...
import de.uprank.cloudsystem.cloudplugin.bootstrap.bukkit.netty.player.PlayerHandler;
...
public class ProxyHandlerClient implements Runnable {
    ...
    public ProxyHandlerClient(CloudBukkitPlugin plugin, String hostName, Integer port) {
        this.plugin = plugin;
            ...
            bootstrap.group(eventLoopGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            channelPipeline.addLast(new ProxyHandler(plugin));
