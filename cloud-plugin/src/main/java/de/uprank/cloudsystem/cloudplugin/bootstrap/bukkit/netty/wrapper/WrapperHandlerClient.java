...
import de.uprank.cloudsystem.cloudplugin.bootstrap.bukkit.netty.server.ServerHandler;
...
public class WrapperHandlerClient implements Runnable {
    ...
    public WrapperHandlerClient(CloudBukkitPlugin plugin, String hostName, Integer port) {
        this.plugin = plugin;
            ...
            bootstrap.group(eventLoopGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            channelPipeline.addLast(new WrapperHandler(plugin));
